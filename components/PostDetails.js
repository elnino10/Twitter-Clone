...
import { panelState } from "@/atom/modalAtom";
...
const PostDetails = ({ postId, post, postLikes, db }) => {
  ...
  return (
    <section
      ...
      className="sm:ml-24 xl:ml-[25rem] border-black-100 border-l border-r shadow mt-1 flex-grow max-w-[597px] relative"
    >
        ...
        <div className="px-10">
          ...
          <div className="flex items-center px-5 py-3 border-b ml-5 w-[90%] text-xs">
            <p className="text-gray-500 mr-3">
              <span className="mr-1 text-gray-700 font-bold ">15</span>Retweets
            </p>
            <p className="text-gray-500 mr-3">
              <span className="mr-1 text-gray-700 font-bold">2</span>Quotes
            </p>
            <p className="text-gray-500 mr-3">
              <span className="mr-1 text-gray-700 font-bold">{numLikes}</span>
              Likes
            </p>
            <p className="text-gray-500 mr-3">
              <span className="mr-1 text-gray-700 font-bold">1</span>Bookmark
            </p>
          </div>
      ...
      <CommentSection postId={postId} db={db} comments={comments} />
    </section>
  );
};
